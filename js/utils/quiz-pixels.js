...
;(function () {
  ...
  function init(pixels) {
    ...
    if (pixels.google_tag_id)     _initGoogle(pixels.google_tag_id)
    if (pixels.google_ads_id && pixels.google_tag_id) {
      // Google Ads needs gtag loaded first — piggybacks on google_tag_id
    }
