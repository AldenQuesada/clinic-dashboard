/**
 * GrowthMetricsRepository — consome RPCs do migration 386.
 * IIFE puro. Zero DOM.
 */
;(function () {
  'use strict'
  ...
  window.GrowthMetricsRepository = Object.freeze({
    funnel:      function (days) { return _rpc('vpi_funnel_breakdown',           { p_days: days || 30 }) },
    timeseries:  function (bucket, periods) { return _rpc('vpi_timeseries',      { p_bucket: bucket || 'month', p_periods: periods || 12 }) },
    ...
    velocity:    function (days) { return _rpc('vpi_velocity',                   { p_days: days || 30 }) },
    ...
    payback:     function (days) { return _rpc('vpi_payback_analysis',           { p_days: days || 90 }) },
