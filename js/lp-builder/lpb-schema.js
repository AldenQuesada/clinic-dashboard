    ...
    'location-map': {
      ...
      fields: [
        ...
        { k: 'gallery_photos', label: 'Fotos do prédio (carrossel top-right)', type: 'list',
          ...
          hint: 'Adicione fotos da fachada/porta/recepção. Vazio = sem carrossel. 1+ fotos = carrossel pequeno no canto.' },
        { k: 'gallery_position', label: 'Posição do carrossel', type: 'select',
          options: [
            { value: 'top-right',    label: 'Canto superior direito (default)' },
        ...
        { k: 'gallery_tag', label: 'Etiqueta do carrossel', type: 'text', max: 20, default: 'Conheça',
