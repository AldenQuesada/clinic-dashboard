  ...
  var BLOCK_META = {
    ...
    'location-map': {
      ...
      fields: [
        ...
        { k: 'address', label: 'Endereço (linha 1)', type: 'text', max: 60, default: 'Av. Brasil, 4242' },
        { k: 'city',    label: 'Cidade / Estado',     type: 'text', max: 40, default: 'Maringá / PR' },
        { k: 'hours_summary', label: 'Resumo de horários', type: 'text', max: 80, default: 'Seg a Sex 9h-19h · Sáb 9h-13h' },
        { k: 'show_open_status', label: 'Mostrar chip ABERTO/FECHADO', type: 'bool', default: true },
        { k: 'whatsapp_url',   label: 'URL WhatsApp',   type: 'text', default: 'https://wa.me/5544999999999' },
        ...
        { k: 'waze_url',       label: 'URL Waze', type: 'text', default: 'https://waze.com/ul?q=Clinica+Mirian+Paula+Maringa' },
    ...
    'location-facade': {
      ...
      fields: [
        ...
        { k: 'address', label: 'Endereço completo', type: 'text', max: 100, default: 'Av. Brasil, 4242 — Maringá/PR' },
        { k: 'chip_1', label: 'Chip 1', type: 'text', max: 30, default: '8 min do Shopping' },
        { k: 'chip_2', label: 'Chip 2', type: 'text', max: 30, default: '12 min do Aeroporto' },
        { k: 'chip_3', label: 'Chip 3', type: 'text', max: 30, default: '5 min do Centro' },
        { k: 'chip_4', label: 'Chip 4', type: 'text', max: 30, default: 'Estacionamento próprio' },
        { k: 'whatsapp_url',   label: 'URL WhatsApp',   type: 'text', default: 'https://wa.me/5544999999999' },
        { k: 'whatsapp_label', label: 'Label WhatsApp', type: 'text', max: 24, default: 'Falar no WhatsApp' },
        { k: 'maps_url',       label: 'URL Google Maps', type: 'text', default: 'https://maps.google.com/?q=Clinica+Mirian+Paula' },
    ...
    'location-story': {
      ...
      fields: [
        ...
        { k: 'address', label: 'Endereço (multilinha)', type: 'textarea', max: 120, rows: 2,
          default: 'Av. Brasil, 4242\nMaringá/PR · CEP 87013-000' },
        { k: 'hours_weekday',  label: 'Horário Seg-Sex', type: 'text', max: 40, default: 'Seg a Sex · 9h às 19h' },
        { k: 'hours_saturday', label: 'Horário Sábado',   type: 'text', max: 40, default: 'Sábado · 9h às 13h' },
        { k: 'hours_sunday',   label: 'Horário Domingo',  type: 'text', max: 40, default: 'Domingo · Fechado' },
        { k: 'chip_1', label: 'Chip 1', type: 'text', max: 30, default: 'Estacionamento próprio' },
        { k: 'chip_2', label: 'Chip 2', type: 'text', max: 30, default: 'Acessibilidade total' },
        { k: 'chip_3', label: 'Chip 3', type: 'text', max: 30, default: 'WiFi grátis' },
        { k: 'whatsapp_url',   label: 'URL WhatsApp',   type: 'text', default: 'https://wa.me/5544999999999' },
    ...
    'location-iphone': {
      ...
      fields: [
        ...
        { k: 'address',      label: 'Endereço',         type: 'text', max: 80, default: 'Av. Brasil, 4242 · Maringá/PR' },
        { k: 'rating',       label: 'Nota (rating)',    type: 'text', max: 5, default: '5,0' },
        { k: 'reviews_count',label: 'Nº avaliações',    type: 'text', max: 6, default: '127' },
        { k: 'open_status',  label: 'Status horário',   type: 'text', max: 30, default: 'Aberto · Fecha às 19h' },
        { k: 'maps_url',         label: 'URL desktop Maps', type: 'text', default: 'https://maps.google.com/?q=Clinica+Mirian+Paula' },
        { k: 'ios_maps_url',     label: 'URL iOS Maps',     type: 'text', default: 'maps://?q=Clinica+Mirian+Paula' },
        { k: 'android_geo_url',  label: 'URL Android geo:', type: 'text', default: 'geo:0,0?q=Clinica+Mirian+Paula' },
