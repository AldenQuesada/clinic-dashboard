-- ============================================================
-- Fix: wa_log_message aceita content_type e media_url
-- Para que imagens, audios e videos sejam salvos corretamente
-- ============================================================
...
-- Drop old signature (9 params) to avoid overload conflict
