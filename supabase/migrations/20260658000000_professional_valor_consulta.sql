-- ============================================================
-- Migration: professional_profiles → valor_consulta padrao
-- ============================================================
-- Adiciona coluna valor_consulta (default consultation fee per
-- professional) e atualiza get_professionals + upsert_professional
-- para ler e gravar o novo campo.
-- ============================================================

ALTER TABLE public.professional_profiles
  ADD COLUMN IF NOT EXISTS valor_consulta numeric(12,2);

-- ── RPC: get_professionals (acrescenta valor_consulta) ──────
...
-- ── RPC: upsert_professional (acrescenta p_valor_consulta) ──
