-- ============================================================
-- Migration: intervalo_sessoes_dias em clinic_procedimentos
-- ============================================================
-- Permite cadastrar o intervalo padrao entre sessoes de um procedimento
-- (ex: Tirzepatida = 7 dias entre sessoes). Usado pelo modal de agendamento
-- pra auto-preencher o bloco de Recorrencia quando o procedimento e
-- adicionado.
-- ============================================================

ALTER TABLE public.clinic_procedimentos
  ADD COLUMN IF NOT EXISTS intervalo_sessoes_dias int;

COMMENT ON COLUMN public.clinic_procedimentos.intervalo_sessoes_dias IS
  'Intervalo padrao em dias entre sessoes do procedimento (ex: 7 = semanal). Usado pelo modal de agendamento pra auto-preencher recorrencia.';

-- ── RPC: get_procedimentos — retorna o novo campo ──
...
-- ── RPC: upsert_procedimento — aceita o novo campo ──
...
BEGIN
  ...
  INSERT INTO public.clinic_procedimentos (
    ...
    duracao_min, sessoes, intervalo_sessoes_dias, tipo, preco,
    ...
    COALESCE(p_duracao_min, 60), COALESCE(p_sessoes, 1), p_intervalo_sessoes_dias,
