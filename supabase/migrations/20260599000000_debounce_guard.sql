-- ============================================================
-- Migration: Debounce Guard
-- Adds a 5-second debounce check to wa_guard_check.
-- If another inbound message from the same phone arrived
-- in the last 5 seconds (but more than 1 second ago),
-- the current invocation is blocked so that the final
-- message in the burst is the one that triggers processing.
-- ============================================================
