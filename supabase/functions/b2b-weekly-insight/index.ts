...
async function buildSignals(): Promise<any[]> {
  ...
  const partnerships = await table('b2b_partnerships?clinic_id=eq.00000000-0000-0000-0000-000000000001&status=eq.active&select=id,name,pillar,tier,health_color,dna_score,created_at,voucher_unit_cost_brl,monthly_value_cap_brl')
  ...
  try {
    ...
    if (!force) {
      const existing = await table(
        'b2b_insights?clinic_id=eq.00000000-0000-0000-0000-000000000001&week_ref=eq.' +
